    ...
    if (typeof E != 'string' && !Array.isArray(E)) {
      for (const c in E)
        if (c !== 'default' && !(c in p)) {
          ...
          l && Object.defineProperty(p, c, l.get ? l : { enumerable: !0, get: () => E[c] });
        }
    }
  }
...
function ut() {
  ...
  function y(E, c, l) {
    ...
    return ((c = l.ref), { $$typeof: p, type: E, key: m, ref: c !== void 0 ? c : null, props: l });
  }
  return ((C.Fragment = v), (C.jsx = y), (C.jsxs = y), C);
}
var D;
function ot() {
  return (D || ((D = 1), (w.exports = ut())), w.exports);
}
var ct = ot(),
  x = { exports: {} },
  r = {};
...
function st() {
  ...
  var M = {
    ...
    k = {};
  function R(t, e, u) {
    ((this.props = t), (this.context = e), (this.refs = k), (this.updater = u || M));
  }
  ...
  var j = (S.prototype = new N());
  ((j.constructor = S), Y(j, R.prototype), (j.isPureReactComponent = !0));
  var I = Array.isArray;
  function h() {}
  ...
  function O(t, e, u) {
    var n = u.ref;
    return { $$typeof: p, type: t, key: e, ref: n !== void 0 ? n : null, props: u };
  }
  function Z(t, e) {
  ...
  var L = /\/+/g;
  function g(t, e) {
    return typeof t == 'object' && t !== null && t.key != null ? F('' + t.key) : e.toString(36);
  }
  function K(t) {
    switch (t.status) {
      case 'fulfilled':
  ...
  function T(t, e, u, n, o) {
        ...
        case 'object':
          switch (t.$$typeof) {
            ...
            case v:
              ...
              break;
            case H:
              return ((f = t._init), T(f(t._payload), e, u, n, o));
          }
      }
    if (f)
      return (
    ...
    var _ = n === '' ? '.' : n + ':';
    if (I(t))
      for (var a = 0; a < t.length; a++) ((n = t[a]), (s = _ + g(n, a)), (f += T(n, e, u, s, o)));
    else if (((a = X(t)), typeof a == 'function'))
      for (t = a.call(t), a = 0; !(n = t.next()).done; )
        ((n = n.value), (s = _ + g(n, a++)), (f += T(n, e, u, s, o)));
    else if (s === 'object') {
      if (typeof t.then == 'function') return T(K(t), e, u, n, o);
      throw (
        (e = String(t)),
        Error(
  ...
  return (
    ...
    (r.cloneElement = function (t, e, u) {
      ...
      if (s === 1) n.children = u;
        ...
        for (var f = Array(s), _ = 0; _ < s; _++) f[_] = arguments[_ + 2];
        n.children = f;
      }
      return O(t.type, o, n);
    }),
    ...
    (r.createElement = function (t, e, u) {
      ...
      if (e != null)
        for (n in (e.key !== void 0 && (s = '' + e.key), e))
          q.call(e, n) && n !== 'key' && n !== '__self' && n !== '__source' && (o[n] = e[n]);
      var f = arguments.length - 2;
      if (f === 1) o.children = u;
      else if (1 < f) {
        for (var _ = Array(f), a = 0; a < f; a++) _[a] = arguments[a + 2];
        o.children = _;
      }
      if (t && t.defaultProps)
        for (n in ((f = t.defaultProps), f)) o[n] === void 0 && (o[n] = f[n]);
      return O(t, s, o);
    }),
    ...
    (r.isValidElement = P),
    (r.lazy = function (t) {
      return { $$typeof: H, _payload: { _status: -1, _result: t }, _init: V };
    }),
    (r.memo = function (t, e) {
    ...
    (r.startTransition = function (t) {
      ...
      try {
        var n = t(),
          o = i.S;
        (o !== null && o(u, n),
          typeof n == 'object' && n !== null && typeof n.then == 'function' && n.then(h, b));
      } catch (s) {
        b(s);
      } finally {
...
var J;
function it() {
  return (J || ((J = 1), (x.exports = st())), x.exports);
}
var G = it();
const ft = nt(G),
  pt = rt({ __proto__: null, default: ft }, [G]);
export { ft as R, G as a, pt as b, ct as j, it as r };
