<img height="80" alt="logo2" src="https://github.com/user-attachments/assets/78a6bc96-7746-4797-99c1-91a9403731ec" />
...
- 캐러셀로 핵심 기능과 슬로건을 하나의 흐름으로 소개하고,
...
### 🛍️ 중고 기기 탐색 · 구매
- 원하는 제품을 다양한 방법으로 탐색
- 제조사·모델·가격 기준 필터와 직접 검색으로 원하는 기기를 빠르게 찾고,
...
### 📦 내 기기 판매 등록
- 판매 등록부터 확인과 수정까지 ONE-STEP
- 필요한 정보를 입력하고 등록·수정·삭제까지 한 번에
...
### 💬 실시간 채팅 (루핏톡)
- 중고거래 연락도 루핏톡 안에서
- STOMP WebSocket 기반 실시간 채팅으로 구매자와 판매자가 직접 소통
