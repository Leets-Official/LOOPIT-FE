export const footerStyles = {
  root: ['w-full', 'bg-white', 'py-[60px]', 'border-t', 'border-gray-100'].join(' '),
  ...
  infoRow: ['flex', 'items-center', 'gap-4', 'typo-caption-1', 'text-gray-400'].join(' '),
  infoLabel: ['font-medium'].join(' '),
  infoValue: ['font-normal'].join(' '),
  separator: ['h-[10px]', 'w-[1px]', 'bg-gray-300'].join(' '),
