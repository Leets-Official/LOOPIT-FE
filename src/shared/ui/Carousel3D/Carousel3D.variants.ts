...
export const carousel3DVariants = tv({
  slots: {
    ...
    slide: [
      ...
      'min-h-[320px]',
      'bg-gradient-to-br',
      'from-[var(--color-gray-900)]/90',
      'to-[var(--color-gray-800)]/70',
      'backdrop-blur-xl',
      'border',
      'border-[var(--color-gray-700)]/30',
    ...
    title: ['text-3xl', 'md:text-4xl', 'font-bold', 'text-[var(--color-white)]', 'text-center', 'mt-2'],
    ...
    pagination: [
      ...
      '[&_.swiper-pagination-bullet]:bg-[var(--color-gray-600)]',
      '[&_.swiper-pagination-bullet]:opacity-100',
      '[&_.swiper-pagination-bullet]:transition-all',
      '[&_.swiper-pagination-bullet]:mx-1',
      '[&_.swiper-pagination-bullet-active]:bg-[var(--color-brand-primary)]',
